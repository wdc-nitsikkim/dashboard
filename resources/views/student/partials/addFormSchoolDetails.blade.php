...
<div class="col-6 col-sm-3 col-lg-2 mb-2">
    <div class="form-floating">
        <input type="number"
            ...
            value="{{ old($class . '_score') }}" min="0" step="0.01" required>
    ...
    <div class="form-floating">
        <select class="form-select {{ $errors->has($class . '_marking_scheme') ? 'is-invalid' : '' }}"
            ...
            @foreach ($selectMenu['marking_schemes'] as $scheme)
                <option value="{{ $scheme }}"
                    {{ old($class . '_marking_scheme') == $scheme ? 'selected' : '' }}>
                    {{ strtoupper($scheme) }}
                </option>
            @endforeach
...
<div class="col-6 col-sm-3 col-lg-2 mb-2">
    <div class="form-floating">
        <input type="number"
            ...
            value="{{ old($class . '_passing_year') }}" min="2010" max="{{ date('Y') }}" required>
